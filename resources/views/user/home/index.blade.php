...
@section('title', 'Global_history - ' . \App\Models\Option::getvalue('sitename'))
@section('seo')
...
@section('content')
    ...
    <div class="container visible-md-block visible-lg-block" id="intro-index">
        <div class="title-list">
            <h2><a href="" title="Bài biết đáng chú ý">Bài biết đáng chú ý <span class="glyphicon glyphicon-fire"></span></a></h2>
    ...
    <div class="container" id="list-index">
        ...
        <div class="list list-truyen list-new col-xs-12 col-sm-12 col-md-8 col-truyen-main">
            <div class="title-list">
                <h2><a href="" title="Bài viết mới">Bài viết mới <span class="glyphicon glyphicon-menu-right"></span></a></h2>
