...
<div class="container" id="truyen-slide">
    <div class="list list-thumbnail col-xs-12">
        <div class="title-list"><h2><a href="{{route('danhsach.truyenfull')}}" title="Bài viết đã hoàn thành">Bài viết đã hoàn thành</a></h2><a href="#" title="Bài viết đã hoàn thành"><span class="glyphicon glyphicon-menu-right"></span></a></div>
        <div class="row">
            @if($stories)
