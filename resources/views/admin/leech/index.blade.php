                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <select id="type" class="form-control">
                                    <option value="History.com">History.com</option>
                                    <option value="Global.vn">Global.vn</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label>URL</label>
        ...
        $("#dqhStoryFormLeech").on('submit', function(e){
            ...
            $.ajax({
                ...
                success: function(data){
                    $("#log").text("<br>Đã nhận được thông tin bài viết ...<br>");
                    $("#log").append("Đang lấy thông tin ...<br>");
                    $("#log").append("Đã lưu...Lấy chương bài viết<br>");
