                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                @else
                                    <div class="pull-right">
                                        <a href="{{ route('user.logout') }}" class="btn btn-default btn-flat">Đăng xuất</a>
                                    </div>
                                @endif
                                @if($level == 1)
                                    <div class="pull-left">
                                        <div class="hihi">
                                            <a href="{{route('user.home')}}" class="fa fa-home" style="font-size: 30px"> <span></span></a>
                                        </div>
                                    </div>
                                @endif
            ...
            <ul class="sidebar-menu navigation" data-widget="tree">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ route('admin.story.index') }}"><i class="fa fa-circle-o"></i> Danh sách bài viết</a></li>
                        <li><a href="{{ route('admin.chapter.index') }}"><i class="fa fa-circle-o"></i> Danh sách chương</a></li>
                        <li><a href="{{ route('admin.story.create') }}"><i class="fa fa-circle-o"></i> Thêm mới bài viết</a></li>
                        @if(isset($story))
                ...
                <li><a href="{{ route('admin.setting.tos') }}"><i class="fa fa-pencil"></i> Chỉnh sửa Sự Kiện</a></li>
