...
Route::group(['namespace' => 'ControllerUser', 'middleware' => 'web'], function (){
    ...
    Route::get('user/login', 'Auth\LoginController@loginus')->name('user.login');
    Route::post('post/user/login', 'Auth\LoginController@postLogin')->name('post.user.login');
    ...
    Route::group(['prefix' => 'danh-sach'], function() {
        Route::get('bai-viet-dang-chu-y', 'StoryController@getListHotStory')->name('danhsach.truyenhot');
        Route::get('bai-viet-moi', 'StoryController@getListNewStory')->name('danhsach.truyenmoi');
        Route::get('bai-viet-da-hoan-thanh', 'StoryController@getListFullStory')->name('danhsach.truyenfull');
    });
